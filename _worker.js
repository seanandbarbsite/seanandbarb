...
.wgsb-sel{display:none;width:100%;-webkit-appearance:none;appearance:none;border:1px solid rgba(212,175,55,.12);border-radius:10px;background-color:#080f20;color:#f1f5f9;font-family:Inter,system-ui,sans-serif;font-weight:600;font-size:14px;line-height:1;padding:12px 34px 12px 14px;background-image:linear-gradient(45deg,transparent 50%,#D4AF37 50%),linear-gradient(135deg,#D4AF37 50%,transparent 50%);background-position:calc(100% - 18px) 20px,calc(100% - 13px) 20px;background-size:5px 5px,5px 5px;background-repeat:no-repeat;}
.wgsb-sel option{color:#f1f5f9;background:#080f20;}
