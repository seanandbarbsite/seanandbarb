...
.wgsb-card{background:#0B101A;border:1px solid rgba(255,255,255,0.08);border-radius:16px;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,0.45);position:relative;}
.wgsb-bd{padding:14px 16px 16px;}
.wgsb-mast{display:flex;justify-content:space-between;align-items:flex-end;border-bottom:1px solid rgba(255,255,255,0.08);padding-bottom:9px;margin-bottom:12px;}
.wgsb-mast .t{font-family:'Playfair Display',Georgia,serif;font-weight:400;font-size:23px;color:#D4AF37;line-height:1.1;}
.wgsb-mast .e{font-family:'Playfair Display',Georgia,serif;font-style:italic;font-size:12.5px;color:rgba(255,255,255,0.8);white-space:nowrap;padding-left:10px;}
.wgsb-cmp{border:1px solid rgba(255,255,255,0.09);border-radius:12px;background:rgba(255,255,255,0.02);padding:10px 10px 11px;margin:0 0 12px;}
.wgsb-cmplab{font-size:10.5px;letter-spacing:0.16em;text-transform:uppercase;color:rgba(255,255,255,0.72);font-weight:600;margin:0 0 8px;}
.wgsb-ledger{display:grid;grid-template-columns:1fr 1fr;gap:5px;}
.wgsb-ledger button{border:1px solid rgba(255,255,255,0.08);border-radius:10px;padding:9px 4px;background:rgba(255,255,255,0.03);color:rgba(255,255,255,0.88);font-family:Inter,system-ui,sans-serif;font-size:13px;font-weight:600;line-height:1.15;cursor:pointer;-webkit-tap-highlight-color:transparent;transition:border-color .25s ease,background .25s ease;}
.wgsb-ledger button.on{background:rgba(212,175,55,0.10);border-color:#D4AF37;color:#D4AF37;box-shadow:0 0 15px rgba(212,175,55,0.15);}
.wgsb-sel{display:none;width:100%;-webkit-appearance:none;appearance:none;border:1px solid rgba(212,175,55,0.45);border-radius:10px;background-color:rgba(212,175,55,0.08);color:#D4AF37;font-family:Inter,system-ui,sans-serif;font-weight:600;font-size:15px;line-height:1;padding:12px 34px 12px 14px;background-image:linear-gradient(45deg,transparent 50%,#D4AF37 50%),linear-gradient(135deg,#D4AF37 50%,transparent 50%);background-position:calc(100% - 18px) 20px,calc(100% - 13px) 20px;background-size:5px 5px,5px 5px;background-repeat:no-repeat;}
.wgsb-sel option{color:#111214;background:#FFFFFF;}
.wgsb-ptog{display:flex;gap:5px;margin:0 0 14px;}
.wgsb-ptog button{flex:1;border:1px solid rgba(255,255,255,0.08);border-radius:9px;padding:9px 4px;background:rgba(255,255,255,0.03);color:rgba(255,255,255,0.78);font-family:Inter,system-ui,sans-serif;font-size:12.5px;font-weight:600;cursor:pointer;-webkit-tap-highlight-color:transparent;transition:border-color .25s ease,background .25s ease;}
.wgsb-ptog button.on{background:rgba(212,175,55,0.10);border-color:#D4AF37;color:#D4AF37;box-shadow:0 0 15px rgba(212,175,55,0.15);}
.wgsb-pt-trend{font-weight:700;}
.wgsb-pt-trend.up{color:#5FBF7A;}
.wgsb-pt-trend.down{color:#E0645A;}
.wgsb-pbox{border:1px solid rgba(255,255,255,0.08);border-radius:12px;background:rgba(255,255,255,0.03);-webkit-backdrop-filter:blur(12px);backdrop-filter:blur(12px);padding:15px;}
...
.wgsb-cell{background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);border-radius:10px;padding:11px 12px;}
.wgsb-cell.w{grid-column:1/-1;}
.wgsb-pl{font-size:10.5px;letter-spacing:0.14em;text-transform:uppercase;color:rgba(255,255,255,0.78);font-weight:600;margin:0 0 4px;}
.wgsb-cell .v{font-family:'Playfair Display',Georgia,serif;font-weight:400;font-size:26px;color:#FFFFFF;line-height:1;}
...
.wgsb-dl .lb{font-size:10px;letter-spacing:0.1em;text-transform:uppercase;color:rgba(255,255,255,0.68);font-weight:600;min-width:58px;}
.wgsb-u{color:#4ade80;}#sb-wgs-mom{color:#F5EEDF;font-weight:600;}.wgsb-note{font-size:11px;line-height:1.5;color:rgba(255,255,255,.55);margin:5px 0 0;}
...
.wgsb-badge{display:inline-block;background:rgba(212,175,55,0.14);border:1px solid rgba(212,175,55,0.5);color:#D4AF37;border-radius:999px;padding:9px 17px;font-family:Inter,system-ui,sans-serif;font-weight:700;font-size:12px;letter-spacing:0.11em;text-transform:uppercase;line-height:1.25;white-space:nowrap;flex:0 0 auto;}
.wgsb-figcap{display:flex;justify-content:space-between;align-items:baseline;gap:10px;border-bottom:1px solid rgba(255,255,255,0.10);padding-bottom:6px;margin-bottom:9px;}
.wgsb-figcap .ft{font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:rgba(255,255,255,0.92);font-weight:600;}
.wgsb-figcap .fr{font-size:10.5px;letter-spacing:0.1em;text-transform:uppercase;color:rgba(255,255,255,0.68);white-space:nowrap;}
...
.wgsb-sq{background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);border-radius:10px;padding:11px 12px;}
.wgsb-sq .k{font-size:10.5px;letter-spacing:0.13em;text-transform:uppercase;color:rgba(255,255,255,0.78);font-weight:600;}
.wgsb-sq .n{font-family:'Playfair Display',Georgia,serif;font-weight:400;font-size:28px;color:#FFFFFF;line-height:1.05;margin-top:4px;}
.wgsb-sq .n.pend{font-size:17px;color:rgba(255,255,255,0.55);}
.wgsb-sq .w{font-size:12px;color:rgba(255,255,255,0.72);margin-top:6px;line-height:1.45;}
.wgsb-sq.hl{border-color:rgba(212,175,55,0.45);background:rgba(212,175,55,0.06);}
.wgsb-sq.hl .n{color:#D4AF37;}
.wgsb-sq.hl .n.pend{color:rgba(212,175,55,0.45);}
.wgsb-foot{font-size:10px;letter-spacing:0.08em;text-transform:uppercase;color:rgba(255,255,255,.62);margin-top:10px;text-align:center;}
...
section#market-data .section-heading{font-size:clamp(26px,2.6vw,34px) !important;margin-bottom:4px !important;color:#F5EEDF !important;}
section#market-data > .max-w-screen-xl > p.text-sm{margin-top:6px !important;margin-bottom:10px !important;color:#CFC7BA !important;}
...
#sb-home-wgs .wgsb-cell{background:none;border:0;border-bottom:1px solid rgba(255,255,255,0.07);border-radius:0;padding:9px 0;display:flex;align-items:baseline;justify-content:space-between;gap:10px;}
...
<style>#sb-home-wgs .wgsb-cell{border-color:rgba(212,175,55,0.30);}#sb-home-wgs .wgsb-sq:not(.hl){border-color:rgba(212,175,55,0.30);}#sb-home-wgs .wgsb-cmp{border-color:rgba(212,175,55,0.30);}#sb-home-wgs .wgsb-pbox{border-color:rgba(212,175,55,0.30);}section#market-data > .max-w-screen-xl{text-align:center;}section#market-data .section-heading{text-align:center;}section#market-data > .max-w-screen-xl > p{margin-left:auto;margin-right:auto;}@media (min-width:1024px){#sb-home-wgs .wgsb-grid{align-items:stretch;}#sb-home-wgs .wgsb-right{display:flex;flex-direction:column;}#sb-home-wgs .wgsb-right .wgsb-viz{flex:0 0 auto;height:300px;}#sb-home-wgs .wgsb-right .wgsb-act{flex:0 0 auto;}#sb-home-wgs .wgsb-right .sb-mrc{margin-top:auto;flex:0 0 auto;}#sb-home-wgs .wgsb-stats{height:100%;align-content:space-between;margin-bottom:0;}}</style><div class="wgsb" id="sb-home-wgs">
<div class="wgsb-card">
<div class="wgsb-bd">
...
<style>.wgsb-na{color:rgba(255,255,255,.45);font-style:normal}/*sb-mrc*/.sb-mrc{margin-top:14px;padding:14px 14px 15px;border:1px solid rgba(212,175,55,0.28);border-radius:12px;background:rgba(255,255,255,0.045);}.sb-mrc .mrc-l{font-size:11px;letter-spacing:0.16em;text-transform:uppercase;color:#E6C55C;font-weight:700;margin:0 0 9px;font-family:Inter,system-ui,sans-serif;}.sb-mrc form{display:flex;flex-wrap:wrap;gap:7px;justify-content:center;}.sb-mrc input{flex:1 1 120px;min-width:0;border:1px solid rgba(212,175,55,0.40);border-radius:7px;background:rgba(255,255,255,0.10);padding:11px 13px;font-family:Inter,system-ui,sans-serif;font-size:14px;color:#FFFFFF;transition:border-color .2s ease,background .2s ease,box-shadow .2s ease;}.sb-mrc input::placeholder{color:rgba(255,255,255,0.68);}.sb-mrc input:focus{outline:none;border-color:#D4AF37;background:rgba(255,255,255,0.15);box-shadow:0 0 0 3px rgba(212,175,55,0.20);}.sb-mrc input:hover{border-color:rgba(212,175,55,0.62);}.sb-mrc button{flex:0 0 auto;background:#D4AF37;color:#060A11;border:none;border-radius:7px;padding:11px 20px;font-family:Inter,system-ui,sans-serif;font-size:11px;letter-spacing:0.09em;text-transform:uppercase;font-weight:700;cursor:pointer;}.sb-mrc .mrc-hp{position:absolute;left:-6000px;top:auto;}.sb-mrc .mrc-ok{display:none;font-family:Georgia,serif;font-size:13.5px;color:#2E7D4F;margin:2px 0 0;}.sb-mrc .mrc-er{display:none;font-family:Inter,system-ui,sans-serif;font-size:11.5px;color:#B23A2E;margin:4px 0 0;}@media (min-width:768px){#sb-home-wgs .wgsb-foot{margin-top:30px;}#sb-home-wgs .wgsb-bd{padding-bottom:20px;}section#market-data{padding-bottom:72px !important;}}</style>
</div>
</div>
</div>
...
var GOLD='#D4AF37',COL='rgba(96,165,250,0.55)';
...
function drawCombo(svg,D,dur){
 ...
 var s='<rect x="'+pl+'" y="6" width="11" height="9" rx="1.5" fill="'+COL+'"/><text x="'+(pl+17)+'" y="14" font-family="Inter" font-size="11.5" fill="rgba(255,255,255,0.85)">Active Listing Inventory</text>';
 s+='<rect x="'+(pl+165)+'" y="6" width="11" height="9" rx="1.5" fill="'+GOLD+'"/><text x="'+(pl+182)+'" y="14" font-family="Inter" font-size="11.5" fill="rgba(255,255,255,0.85)">Homes Closed</text>';
 [maxV,0].forEach(function(v){var y=Y(v);
  s+='<line x1="'+pl+'" y1="'+y+'" x2="'+(W-pr)+'" y2="'+y+'" stroke="rgba(255,255,255,0.10)" stroke-dasharray="2 4"/>';
  s+='<text x="'+(pl-8)+'" y="'+(y+3)+'" text-anchor="end" font-family="Inter" font-size="11.5" fill="rgba(255,255,255,0.75)">'+v+'</text>';});
 var i;
 ...
 for(var m=0;m<n;m+=2){s+='<text x="'+X(m).toFixed(1)+'" y="'+(H-5)+'" text-anchor="middle" font-family="Inter" font-size="11.5" fill="rgba(255,255,255,0.75)">'+((D.months&&D.months[m])||months[m])+'</text>';}
 svg.innerHTML=s;
