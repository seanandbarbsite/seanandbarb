...
.wgsb-card{background:#141b29;border:1px solid rgba(212,175,55,.4);border-radius:24px;overflow:hidden;box-shadow:0 26px 60px rgba(0,0,0,.5);position:relative;}
...
.wgsb-cmp{border:1px solid rgba(51,65,85,0.5);border-radius:12px;background:#1a2335;padding:10px 10px 11px;margin:0 0 12px;}
...
.wgsb-pbox{border:1px solid rgba(51,65,85,0.5);border-radius:12px;background:#1a2335;padding:15px;}
...
.wgsb-cell{background:#1a2335;border:1px solid rgba(51,65,85,0.5);border-radius:12px;padding:11px 12px;}
...
.wgsb-sq{background:#1a2335;border:1px solid rgba(51,65,85,0.5);border-radius:12px;padding:11px 12px;}
